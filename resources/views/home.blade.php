                            ...
                            <table class='table'>
                                <thead>
                                        <p class="text-center">
                                            ...
                                            @if ($incomeSum[0]['sum'] - $spendSum[0]['sum'] < 0)
                                                <span class="text-danger">{{$incomeSum[0]['sum'] - $spendSum[0]['sum']}}</span>
                                            @else
                                            <span class="text-primary">{{$incomeSum[0]['sum'] - $spendSum[0]['sum']}}</span>
                                            @endif
                                ...
                                <tbody>
                                    ...
                                    <tr class="bg-secondary">
                                        ...
                                        <th scope="col"><span class="text-white">{{ $spendTypeSums[$i]['name'] }}</span></th>
                                        <th scope="col"><span class="text-white">{{ $spendTypeSums[$i]['sum'] }}</span></th>
                                    </tr>
                                    @endfor
                        ...
                        <div class="card-body">
                            <div class="card-body">
                                ...
                                <div class='row justify-content-center'>
                                    <button type='submit' class='btn btn-primary w-25 mt-3'><a class="text-white" href="{{ route('create.income') }}">新規登録</a></button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="card-body">
                            ...
                            {{ $spends->links() }}
                            <div class='row justify-content-center'>
                                <button type='submit' class='btn btn-primary w-25 mt-3'><a class="text-white" href="{{ route('create.spend') }}">新規登録</a></button>
                            </div>
                        </div>
                    </div>
                </div>
